...
public class SecretariaInterface {
    ...
    public void menu() {
        int opcao;
        String header = "Menu da Secretaria - " + secretaria.getNome();
        String[] opcoes = {
    ...
    // Implementações dos métodos de Disciplina
        ...
        if (disciplinas.isEmpty()) {
            ...
            for (Disciplina d : disciplinas) {
                System.out.println("ID: " + d.getId() + 
                                 ...
                                 " | Tipo: " + d.getTipo() + 
                                 " | Status: " + d.getStatus() +
                                 " | Matrículas: " + d.getAlunosMatriculados().size() +
    ...
    private void editarDisciplina() {
        ...
        System.out.print("Novo valor (atual: " + disciplina.getValor() + "): ");
        String novoValorStr = in.nextLine();
    ...
    // Implementações dos métodos de Curso
    ...
    // Implementações dos métodos de Currículo
    ...
    // Implementações dos métodos de Usuários
    ...
    // Implementação da consolidação de matrículas
    private void consolidarMatriculas() {
        System.out.println("Consolidando matrículas...");
        
        ArrayList<IEfetivavel> disciplinasEfetivas = new ArrayList<>();
        for (Disciplina d : disciplinas) {
            disciplinasEfetivas.add(d);
        }
        
        try {
            secretaria.consolidarMatriculas(disciplinasEfetivas, alunos);
    ...
    private void relatorioMatriculasPorDisciplina() {
        ...
        for (Disciplina d : disciplinas) {
            ...
            System.out.println("Alunos matriculados: " + d.getAlunosMatriculados().size());
    ...
    private void relatorioFinanceiro() {
        ...
        System.out.println("Média por Aluno: R$ " + String.format("%.2f", alunos.size() > 0 ? totalReceita / alunos.size() : 0));
    }
